...
import com.cjmobileapps.foodmenuandroid.BuildConfig
import com.cjmobileapps.foodmenuandroid.network.FoodMenuApi
import com.cjmobileapps.foodmenuandroid.network.NetworkConstants
...
class NetworkModule {
    ...
    @Singleton
    @Provides
    fun foodMenuApi(retrofit: Retrofit): FoodMenuApi {
        return retrofit.create(FoodMenuApi::class.java)
    }
}
